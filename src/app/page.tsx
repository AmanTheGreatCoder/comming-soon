	...
	return (
		<>
			<div className='sticky shadow-md top-0 left-0 right-0 w-full h-11 flex justify-center z-[9999] items-center bg-[#f2fbbc]'>
				<p className='text-base font-extralight text-black w-full text-center'>
			...
			<div className='relative flex flex-col lg:flex-row w-full min-h-screen'>
				...
				{/* Icons */}
				<div className='absolute top-0 bottom-0 left-4 z-50 flex flex-col justify-center gap-4'>
					<img
				...
				<div className='relative w-full lg:w-1/2 bg-[#eeeded] h-full md:min-h-screen p-8 flex flex-col justify-center items-center gap-8 max-md:pb-20 pt-10'>
